...
class MainModuleImportTests(unittest.TestCase):
    def test_database_module_no_longer_exposes_sqlite_compat_helpers(self):
        ...
        self.assertFalse(hasattr(database_module, "ensure_gacha_storage_ready"))
        self.assertFalse(hasattr(database_module, "get_gacha_record_legacy_column_ddls"))
        self.assertFalse(hasattr(database_module, "get_gacha_import_job_legacy_column_ddls"))
        self.assertFalse(hasattr(database_module, "get_gacha_record_legacy_index_ddls"))
        self.assertFalse(hasattr(database_module, "get_gacha_import_job_legacy_index_ddls"))
        self.assertFalse(hasattr(database_module, "RETIRED_FEATURE_TABLES"))
        self.assertFalse(hasattr(database_module, "drop_retired_feature_tables"))
