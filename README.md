...
`admin_menu_management` 是管理员保底入口，目的是避免后台把“菜单管理”本身一起关掉后没有恢复路径。

如果你需要临时隐藏某些后台能力，请关闭对应业务菜单，不要关闭菜单管理入口本身。
