    ...
    <div class="login-container">
      ...
      <section class="brand-section">
        <div class="brand-content">
          ...
          <p class="brand-tagline">一站式管理您的游戏账号与签到状态。</p>
        ...
        <el-tabs v-model="activeTab" class="custom-tabs">
          ...
          <el-tab-pane label="注册" name="register">
            ...
            >
              ...
              <el-form-item v-if="inviteRequired" prop="invite_code">
                <el-input
...
const registerForm = reactive({ username: '', password: '', confirmPassword: '', invite_code: '' })
...
async function loadRegisterOptions() {
  try {
    ...
    inviteRequired.value = Boolean(data.invite_required)
  } catch {
...
async function handleRegister() {
  ...
  try {
    await userStore.register(
      ...
      inviteRequired.value ? registerForm.invite_code : undefined,
    )
